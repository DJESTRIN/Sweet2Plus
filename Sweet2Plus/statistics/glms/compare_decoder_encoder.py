...
Description: Compares per-neuron, per-stimulus weights produced by two different modeling
    ...
    (1) circuit_regression (Sweet2Plus/statistics/circuit_coefficient_clustering.py) -- a
    ...
    (2) engelhardglm (Sweet2Plus/statistics/glms/engelhardglm.py + glmsummary.py) -- a per-neuron
...
# Canonical odor order (see Sweet2Plus/core/behavior.py's `trials` list and
