...
if __name__=='__main__':
    cli_command = ["python", r".\NeuroSweet\analysis\CorrelativeActivityAnalysis.py", "--root_data_directory", r"C:\Users\listo\tmt_experiment_2024_working_file"]  # Add your arguments here
